...
export function WearTabsSpecimen({ record, markTrace, onReset }: { record: WearRecord } & WearTrace & Resettable) {
  ...
  return (
    <SpecimenFrame anchor="specimen-tabs" index="05" title="Tabs" material="PRINTED ABS" note="FREQUENCY EXPOSURE" record={record} onReset={onReset}>
...
export function WearNavigationSpecimen({ record, markTrace, onReset }: { record: WearRecord } & WearTrace & Resettable) {
  ...
  return (
    <SpecimenFrame anchor="specimen-navigation" index="06" title="Navigation" material="POWDER COAT" note="ROUTE FREQUENCY" record={record} onReset={onReset}>
