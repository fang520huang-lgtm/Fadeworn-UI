...
export function WearTabsSpecimen({ record, markTrace, onReset }: { record: WearRecord } & WearTrace & Resettable) {
  ...
  return (
    <SpecimenFrame id="tabs" index="05" title="Tabs" material="PRINTED ABS" hint="Switch tabs to build wear." record={record} onReset={onReset}>
...
export function WearNavigationSpecimen({ record, markTrace, onReset }: { record: WearRecord } & WearTrace & Resettable) {
  ...
  return (
    <SpecimenFrame id="navigation" index="06" title="Navigation" material="POWDER COAT" record={record} onReset={onReset}>
